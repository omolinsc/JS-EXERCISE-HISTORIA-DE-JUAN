...
const pasarLaNavidad = function (film, xmasFilm, actor, holidayPlans, endOfStory, me, boolean, notDefined) {
    ...
    console.log(xmasFilm[2], "un piso con mis gatos 🐱, cuando griten eso de...")
    xmasFilm[1]();
    console.log("van a pegar un bote mayor que el que pegámos el día que", xmasFilm[3], "de Reyes");
    ...
    console.log("También hablaremos de");
    holidayPlans.function();
    console.log( "al", holidayPlans.destinoVacaciones[2]);
